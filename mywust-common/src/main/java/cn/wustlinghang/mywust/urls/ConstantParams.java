...
public class ConstantParams {
    ...
    static {
        ...
        collegesTmp.put("7335FFB2C407479C9D3D3A92CFC2A701", "党委组织部");
    ...
    /**
     * 子学院的id列表，key为学院id，value为子学院的id列表
     */
    public static final Map<String, String[]> SUB_COLLEGE_ID_LIST = Collections.unmodifiableMap(collegePartsTmp);
    ...
    static {
        ...
        collegePartsTmp.put("7335FFB2C407479C9D3D3A92CFC2A701", new String[]{"C53EBF84BD4240A5B320BEC25F90B9E5",});
